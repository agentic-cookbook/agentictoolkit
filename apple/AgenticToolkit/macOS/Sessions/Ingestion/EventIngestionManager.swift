...
public class EventIngestionManager: @unchecked Sendable {
    ...
    public var sessionSummarizer: SessionSummarizer?
    ...
    public func parseEventFile(data: Data, fileName: String) -> EventFile? {
    ...
    public func ingestEvent(_ eventFile: EventFile, rawData: Data) throws {
