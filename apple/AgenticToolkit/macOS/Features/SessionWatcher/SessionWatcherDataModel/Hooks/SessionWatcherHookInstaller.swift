...
extension SessionWatcher {
    ...
    public final class SessionWatcherHookInstaller {
        ...
        /// Creates a SessionWatcherHookInstaller.
        /// - Parameters:
        ...
        public func loadSettings() throws -> [String: Any] {
            ...
            guard let json = try JSONSerialization.jsonObject(with: data) as? [String: Any] else {
                throw SessionWatcherHookInstallerError.invalidSettingsFormat
            }
    ...
    public enum SessionWatcherHookInstallerError: Error, LocalizedError {
...
extension SessionWatcher.SessionWatcherHookInstaller: Loggable {
