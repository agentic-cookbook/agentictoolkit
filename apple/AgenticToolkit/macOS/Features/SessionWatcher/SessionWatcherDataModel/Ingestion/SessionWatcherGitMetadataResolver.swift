...
public final class SessionWatcherGitMetadataResolver {

    nonisolated(unsafe) public static let shared = SessionWatcherGitMetadataResolver()
    ...
    public func resolveBranch(cwd: String) -> String {
        // Check cache
