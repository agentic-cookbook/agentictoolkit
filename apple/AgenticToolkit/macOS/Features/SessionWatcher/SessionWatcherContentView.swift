...
public final class SessionWatcherContentView: NSView {
    private let viewModel: SessionWatcherListViewModel
    ...
    public init(viewModel: SessionWatcherListViewModel) {
