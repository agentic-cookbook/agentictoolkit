...
final class SettingsWindowController: NSObject, NSWindowDelegate {
    ...
    func showSettings() {
        ...
        guard let databaseManager = databaseManager else {
            NSLog("AgenticPluginTester: Cannot show settings without database manager")
            return
        }

        guard let pluginManager = pluginManager else {
            NSLog("AgenticPluginTester: Cannot show settings without plugin manager")
            return
        }
        ...
        settingsWindow.title = "AgenticPluginTester Settings"
