...
enum WindowManagerMigration {
    ...
    private static let migrationKey = "AgenticPluginTesterWindowManagerMigrationV1"
    ...
    static func migrateIfNeeded() {
        ...
        let migrations: [(autosaveName: String, wmIdentifier: String)] = [
            ("AgenticPluginTesterSessionPanel", "sessionPanel"),
            ("AgenticPluginTesterSettingsWindow", "settings"),
        ]
        ...
        for (autosaveName, wmIdentifier) in migrations {
            ...
            let key = "AgenticPluginTesterWindowState_\(wmIdentifier)"
