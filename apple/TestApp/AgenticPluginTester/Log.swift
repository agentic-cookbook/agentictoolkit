...
/// Centralized OSLog loggers for AgenticPluginTester, organized by subsystem category.
///
...
///   `log stream --predicate 'subsystem == "com.mikefullerton.AgenticPluginTester"'`
enum Log {
    private static let subsystem = Bundle.main.bundleIdentifier ?? "com.mikefullerton.AgenticPluginTester"
    ...
    /// Terminal sessions: shell spawn, exit, directory changes, OSC commands.
