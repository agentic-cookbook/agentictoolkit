...
final class ActivationTestLog {
    ...
    private let queue = DispatchQueue(label: "com.mikefullerton.agentic-plugin-tester.activation-test-log")
    ...
    private static let logURL: URL = {
        ...
        let dir = appSupport.appendingPathComponent("AgenticPluginTester")
