...
final class SummarizerDebugView: NSView {
    private let log = SummarizerDebugLog.shared
...
final class SummarizerDebugWindowController: NSObject, NSWindowDelegate {
    ...
    func showWindow() {
        ...
        let debugView = SummarizerDebugView(frame: NSRect(x: 0, y: 0, width: 700, height: 500))
        ...
        w.contentView = debugView
        w.isReleasedWhenClosed = false
        w.delegate = self

        WindowManager.shared.restoreFrame(for: w, id: "summarizerDebug")
    ...
    func windowDidMove(_ notification: Notification) {
        ...
        WindowManager.shared.saveFrame(for: window, id: "summarizerDebug")
    }
