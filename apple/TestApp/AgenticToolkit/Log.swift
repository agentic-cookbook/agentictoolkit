...
/// Centralized OSLog loggers for AgenticToolkit, organized by subsystem category.
///
...
///   `log stream --predicate 'subsystem == "com.mikefullerton.AgenticToolkit"'`
enum Log {
    private static let subsystem = Bundle.main.bundleIdentifier ?? "com.mikefullerton.AgenticToolkit"
