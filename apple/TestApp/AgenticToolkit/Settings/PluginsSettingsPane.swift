...
struct PluginDescriptor {
    ...
    private static func iconForIdentifier(_ identifier: String) -> String {
        switch identifier {
        case "com.agentictoolkit.plugin.claude-local": return "terminal"
        case "com.agentictoolkit.plugin.claude-api": return "brain"
        case "com.agentictoolkit.plugin.openai": return "cpu"
        case "com.agentictoolkit.plugin.google": return "globe"
        case "com.agentictoolkit.plugin.openai-compatible": return "slider.horizontal.3"
