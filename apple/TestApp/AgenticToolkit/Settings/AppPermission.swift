...
/// Enumerates the macOS permissions that AgenticToolkit requires to function.
enum AppPermission: Int, CaseIterable {
    ...
    var explanation: String {
        ...
        case .notifications:
            return "Allows AgenticToolkit to notify you when sessions start, end, or become stale."
        case .automation:
    ...
    var settingsPath: String {
        ...
        case .notifications:
            return "Settings → Notifications → AgenticToolkit"
        case .automation:
