...
final class OldSystemSettingsPane: OldSettingsPanelView {
    private let viewModel: WhippetSettingsViewModel
    // Touched only on the main thread; deinit is nonisolated, so `unsafe`
    // is the right escape hatch for the cleanup.
    ...
    private func setupViews() {
        ...
        let hint = NSTextField(wrappingLabelWithString:
            "Whippet needs the following permissions to monitor and activate Claude Code sessions.")
    ...
    @objc private func resetWalkthrough() {
        ...
        alert.informativeText = "The permission walkthrough will run again the next time Whippet launches."
