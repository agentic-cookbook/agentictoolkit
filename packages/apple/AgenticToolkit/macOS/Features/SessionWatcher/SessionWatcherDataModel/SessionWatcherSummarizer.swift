    ...
    public final class SessionWatcherSummarizer: @unchecked Sendable {
        ...
        public enum SummarizerError: Error, LocalizedError {
            ...
            public var errorDescription: String? {
                ...
                case .sessionNotFound(let id): return "SessionWatcherSession not found: \(id)"
        ...
        public func buildSummarizationPrompt(session: SessionWatcherSession, events: [SessionWatcherEvent]) -> String {
            var lines: [String] = []
        ...
        public static func countToolActivity(events: [SessionWatcherEvent]) -> String {
        ...
        public static func distillEvent(_ event: SessionWatcherEvent) -> String {
            let json = parseRawJson(event.rawJson)
            let data = json["data"] as? [String: Any] ?? [:]
        ...
        public static func fitEventsToBudget(events: [SessionWatcherEvent], charBudget: Int) -> [String] {
