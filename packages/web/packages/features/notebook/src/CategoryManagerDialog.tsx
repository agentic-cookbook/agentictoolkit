  ...
  return (
    <>
      ...
      <AlertModal
        ...
        description={
          pendingDelete
            ? `“${pendingDelete.name}” stops being offered anywhere, and notes filed under it become uncategorized. Its subcategories are not retired: any that are also filed elsewhere stay there, and the rest move to the top level.`
            : ""
        }
        confirmLabel="Retire"
        cancelLabel="Cancel"
