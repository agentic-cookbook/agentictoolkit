...
// The hub vitest config has no global afterEach, so RTL's auto-cleanup never registers — tear
// down each render explicitly to keep renders from bleeding across tests.
afterEach(cleanup);
