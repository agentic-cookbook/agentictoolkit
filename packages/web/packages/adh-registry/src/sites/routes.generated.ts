...
//
// HAND-WRITTEN — the three shares it merges are the generated files. Lazy-loaded
...
//
// There are three shares because this package is a submodule of adh, adhmarketing
// and adhplaceholders, each owning part of the fleet and none able to see the
// others' site trees. Each repo's `gen-site-routes.py --region <share>` writes its
// own file whole; nothing writes this one. A single generated file would instead
// be written by whichever repo ran last, with the other two repos' entries
// deleted, and nothing would report it — a shorter map compiles, type-checks,
...
export { SITE_ROUTES_MAIN, SITE_ROUTES_MARKETING, SITE_ROUTES_PLACEHOLDER }
