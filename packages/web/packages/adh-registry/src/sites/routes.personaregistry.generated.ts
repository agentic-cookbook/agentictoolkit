...
// Regenerate: python3 <websites-root>/tools/gen-site-routes.py --region personaregistry
//
// personaregistry's share of the fleet's page routes, derived from that repo's App Router
// trees. The rest is in its siblings `routes.devteam.generated.ts`, `routes.hub.generated.ts`, `routes.main.generated.ts`, `routes.marketing.generated.ts`, `routes.placeholder.generated.ts`, written by the other repos;
...
//
// `gen-site-routes.py --region personaregistry --check` re-derives this map in that
...
export const SITE_ROUTES_PERSONAREGISTRY: Partial<Record<SiteId, readonly string[]>> = {
  personaregistry: [
    '/',
    '/[slug]',
    '/[slug]/[persona]',
