...
// trees. The rest is in its siblings `routes.community.generated.ts`, `routes.cookbook.generated.ts`, `routes.devteam.generated.ts`, `routes.docs.generated.ts`, `routes.main.generated.ts`, `routes.marketing.generated.ts`, `routes.personaregistry.generated.ts`, `routes.placeholder.generated.ts`, `routes.registry.generated.ts`, `routes.research.generated.ts`, `routes.shipr.generated.ts`, `routes.toolkit.generated.ts`, written by the other repos;
...
export const SITE_ROUTES_HUB: Partial<Record<SiteId, readonly string[]>> = {
  ...
  hub: [
    ...
    '/[workspace]/members',
    '/[workspace]/messaging/[[...path]]',
    '/[workspace]/narratives/[[...path]]',
    '/[workspace]/news/[[...path]]',
