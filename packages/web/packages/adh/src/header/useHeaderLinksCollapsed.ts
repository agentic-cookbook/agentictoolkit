...
export const HEADER_LINKS_COLLAPSE_QUERY = '(max-width: 768px)'
 ...
 */
export function useHeaderLinksCollapsed(): boolean {
  ...
  return useSyncExternalStore(
    ...
    () =>
      typeof window !== 'undefined' && !!window.matchMedia
        ? window.matchMedia(HEADER_LINKS_COLLAPSE_QUERY).matches
        : false,
    () => false,
  )
}
