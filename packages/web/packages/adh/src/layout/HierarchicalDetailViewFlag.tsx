 ...
 */
export function HierarchicalDetailViewFlag({ children }: { children: ReactNode }) {
  return <HierarchicalDetailViewProvider menuDetail={false}>{children}</HierarchicalDetailViewProvider>
}
