...
export declare function DebugConsoleProvider({ config, children, }: {
    config: DebugConsoleConfig;
    children: ReactNode;
}): import("react").JSX.Element;
export declare function useDebugConsoleConfig(): DebugConsoleConfig;
//# sourceMappingURL=DebugConsoleProvider.d.ts.map