 ...
 */
export declare function servesConceptDetails(siteId: SiteId): boolean;
/**
 ...
 */
export declare function conceptDetailsUrl(conceptId: string, ownerSiteId: SiteId | undefined, currentSiteId: SiteId): string;
//# sourceMappingURL=details-links.d.ts.map