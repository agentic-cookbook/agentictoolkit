 ...
 */
export declare function docContentKey(slug: string): string;
/** The pre-rendered HTML for a doc slug (inject with `MarkdownHtml`), or `undefined` if there's no
 *  content file for it. */
export declare function getDocHtml(slug: string): string | undefined;
...
export declare function getDocHtmlByKey(key: string): string | undefined;
